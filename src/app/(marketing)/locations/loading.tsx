export default function PublicLocationsLoading() {
  return (
    <div className="flex flex-col w-full animate-pulse" aria-label="Loading growth corridors...">
      {/* Hero Skeleton */}
      <div className="bg-[#071a28] py-16 sm:py-24 text-white">
        <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
          ...
          <div className="h-4 w-80 max-w-full bg-white/20 rounded-md" />
        </div>
      </div>
