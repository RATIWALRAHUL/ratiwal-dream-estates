...
import { PortalKycView } from "@/components/portal/PortalKycView";
import { PortalHomeSkeleton } from "@/components/portal/PortalSkeletons";

export const dynamic = "force-dynamic";

export const metadata = {
  title: "KYC & Identity Verification | Ratiwal Customer Portal",
  description: "Upload and verify statutory identification documents.",
  robots: {
    index: false,
    follow: false,
  },
...
export default async function PortalKycPage() {
  ...
  const data = await PortalQueryService.getCustomerKycData(session);
