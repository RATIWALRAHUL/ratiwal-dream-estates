...
export const metadata = {
  title: "Customer Workspace | Ratiwal Dream Estates Portal",
  description: "Private customer overview of bookings, payment schedules, and verified records.",
  robots: {
    index: false,
    follow: false,
  },
