...
export default function PropertiesError({
  ...
  useEffect(() => {
    console.error("[Dashboard Properties Error Caught]:", error.message);
  }, [error]);
    ...
    <div className="min-h-[350px] flex items-center justify-center p-6">
      <div className="max-w-md w-full p-8 rounded-3xl bg-white border border-rose-100 shadow-lg text-center space-y-4">
        ...
        <p className="text-xs text-[#647581]">
          An unexpected error occurred while querying the property catalog. Please try resetting your search filters or refreshing.
        </p>
        <button
          type="button"
          onClick={() => reset()}
