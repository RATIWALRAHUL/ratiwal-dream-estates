    ...
    return (
      <div className="w-full flex flex-col space-y-1.5">
        ...
        <textarea
          ...
          id={id}
          className={cn(
            "w-full min-h-[120px] rounded border border-border-color bg-white px-3.5 py-2.5 text-sm text-text-main placeholder:text-text-muted transition-colors focus-visible:outline focus-visible:ring-2 focus-visible:ring-primary-blue",
