...
export function RelatedPropertiesGrid({
  ...
  return (
    <section aria-labelledby="related-properties-heading" className="mt-16 pt-12 border-t border-[rgba(7,26,40,0.1)]">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
        ...
        <Link
          href="/properties"
          className="inline-flex items-center gap-1.5 text-xs font-bold text-[#0784C8] hover:text-[#031C2B] uppercase tracking-wider transition-colors"
        >
