...
export function PropertyFinalCTA({ propertyName, locationName }: PropertyFinalCTAProps) {
  ...
  return (
    <section className="py-16 md:py-24 bg-[#F5F1E9] border-t border-[rgba(7,26,40,0.08)] mt-16" aria-labelledby="property-final-cta-heading">
        ...
        <div className="relative rounded-3xl bg-gradient-to-br from-[#031C2B] via-[#072435] to-[#082B3B] text-white p-8 sm:p-12 lg:p-16 overflow-hidden shadow-[0_24px_60px_rgba(3,28,43,0.3)] border border-[rgba(255,255,255,0.12)]">
          ...
          <div className="relative z-10 max-w-[720px] mx-auto text-center">
            ...
            <h2
              ...
              className="font-heading text-3xl sm:text-4xl lg:text-[2.75rem] font-normal leading-[1.15] tracking-tight mb-4 text-white"
            >
              Need help evaluating this opportunity?
            </h2>

            {/* Supporting Text */}
            <p className="text-sm sm:text-base text-[#c5d8e4] leading-relaxed max-w-[580px] mx-auto mb-8">
