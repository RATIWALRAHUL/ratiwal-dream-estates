...
export function PropertyBrochureDownloads({
  ...
  return (
    <section aria-labelledby="downloads-heading" className="mb-8 sm:mb-12">
      <div className="p-4 sm:p-7 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-[rgba(7,26,40,0.08)] shadow-[0_4px_24px_rgba(7,26,40,0.04)]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-5">
          {downloads.map((item, idx) => (
            <div
              key={idx}
              className="p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-[#F5F1E9] border border-[rgba(7,26,40,0.08)] flex flex-col justify-between"
            >
              <div>
