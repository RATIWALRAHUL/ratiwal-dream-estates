    ...
    >
      <div className="p-5 rounded-2xl bg-white border border-[rgba(7,26,40,0.08)] shadow-sm">
        <div className="flex items-center gap-2 pb-3 mb-3 border-b border-[rgba(7,26,40,0.06)]">
          <ListFilter size={15} className="text-[var(--ratwal-blue)]" />
            ...
            return (
              <a
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-[var(--mist-blue)] text-[var(--ratwal-blue-deep)] font-bold shadow-2xs translate-x-1"
        ...
        <div className="pt-4 mt-4 border-t border-[rgba(7,26,40,0.06)]">
          <button
            type="button"
            onClick={scrollToTop}
            className="w-full flex items-center justify-center gap-1.5 py-2 px-3 rounded-lg text-[11px] font-bold text-[var(--text-secondary)] hover:text-[var(--ratwal-blue)] hover:bg-[var(--surface)] transition-colors"
          >
            <ArrowUp size={13} />
